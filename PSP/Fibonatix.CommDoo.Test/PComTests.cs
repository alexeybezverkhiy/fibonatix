...
namespace Fibonatix.CommDoo.Test
{
    class PComTests
    {
        ...
        string configuration =
                ...
                "<Configuration>" +
                "<Name>mid_q</Name>" +
                "<Value>3c5957a6</Value>" +
                "</Configuration>" +
                "<Configuration>" +
                "<Name>acquirer</Name>" +
                "<Value>processing.com</Value>" +
                "</Configuration>" +
                "<Configuration>" +
                "<Name>testmode</Name>" +
                "<Value>true</Value>" +
        ...
        public Responses.CaptureResponse CaptureTest(string providerID = null, string authCode = null) {
        ...
        public void PreauthPlusCaptureTest() {
            ...
            var capRes = CaptureTest(preRes.preAuth.transaction.processing_status.ProviderTransactionID, preRes.preAuth.transaction.processing_status.AuthCode);
        }
        ...
        public Responses.SingleReconcileResponse Reconcile() {
            ...
            string xml =
                ...
                "<ProviderTransactionID>48531794</ProviderTransactionID>" +
                "</Transaction>" +
                "</Reconcile>" +
                "</Request>";
        ...
        public void FullTests() {
            ...
            // PurchaseRecurrenceTest("REPEATED", r.purchase.transaction.processing_status.ProviderTransactionID);      // ACK
