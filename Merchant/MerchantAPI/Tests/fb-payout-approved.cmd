...
@set requestData=account_number=1234567890^&amount=100^&bank_branch=test_branch^&bank_name=test_bank^&client_orderid=%paramClientOrderId%^&currency=USD

curl %optProxy% --trace-ascii %fileTraceLog% --trace-time -H '%headerData%' --data '%requestData%^&%headerData%' %url%
