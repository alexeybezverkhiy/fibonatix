...
{
    public class ReturnRequestModel : BaseFibonatixModel
    {
        [Required]
    ...
    public class ReturnResponseModel : SaleResponseModel
    {
        public ReturnResponseModel(string clientOrderId) : base(clientOrderId)
        {
        }
