...
{
    public class SaleFormRequestModel : BaseFibonatixModel
    {
        [Required]
        [StringLength(65535)]
    ...
    public class SaleFormResponseModel
    {
        ...
        public SaleFormResponseModel(string clientOrderId)
        {
    ...
    public class SaleFormBasePaymentModel
    {
        [Required]
    ...
    public class SaleFormFailurePaymentModel : SaleFormBasePaymentModel
    {
        [Required]
    ...
    public class SaleFormSuccessPaymentModel : SaleFormBasePaymentModel
    {
        [Required]
        public string customerredirecturl { get; set; }
